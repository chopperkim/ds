...
s = "3141592653589793238462643383279502884197169399375105820974944592307816406286208998628034825342117067"
answer = list(s)
ok = 0
...
for i, n in enumerate(nlist):
    ...
    if ans == int(answer[i]):
        ...
        print(f"[ng]{i}번재{ans}!={answer[i]}{np.int32(n*100)}")

print(f"정답률: {ok / len(nlist)}")